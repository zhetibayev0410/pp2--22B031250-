...
def main():
    ...
    # loading the images 
    clock_image = pygame.transform.scale(pygame.image.load('./pictures/mickeyclock.jpg'), (800, 600))
    sechand_image = pygame.image.load('./pictures/righthand.jpg')
    sechand_image = pygame.transform.scale(sechand_image, (250, 75))
    sechand_rect = sechand_image.get_rect()
    sechand_rect.center = (400, 300)
    minhand_image = pygame.image.load('./pictures/lefthand.jpg')
