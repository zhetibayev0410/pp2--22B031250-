...
f1 = pg.font.Font('lab8/abcd.ttf', 20)
f2 = pg.font.Font('lab8/abcd.ttf', 25)

screen=pg.display.set_mode((SCR_W, SCR_H))
pg.display.set_caption("capybara racer")

icon=pg.image.load("lab8/pictures/iconn.png")
icon2=pg.image.load("lab8/pictures/iconn2.png")


bg=pg.image.load("lab8/pictures/background.png")
bg1=pg.image.load("lab8/pictures/backgrounddead.png")
...
class Enemy(pg.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pg.image.load("lab8/pictures/enemy1.png")
...
class Player(pg.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pg.image.load("lab8/pictures/capidef.png")
        self.imagecool=pg.image.load("lab8/pictures/capihapi.png")
        self.imagefail=pg.image.load("lab8/pictures/capidead.png")
        self.rect = self.image.get_rect()
...
class Coins(pg.sprite.Sprite):
    def __init__(self):
        ...
        if self.mode==0:
            self.image=pg.image.load("lab8/pictures/banana.png")
        else:
            self.image = pg.image.load("lab8/pictures/orange.png")
        self.rect = self.image.get_rect()
